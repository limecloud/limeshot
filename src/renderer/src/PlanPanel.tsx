        ...
        <div className="plan-content">
          ...
          {plan.state === 'ready_for_review' ? (
            <div className="plan-actions">
              <button className="secondary-command" type="button" disabled={deciding} onClick={() => void decide('request_changes')}>
          ...
          {receipt ? (
            <p className="approval-receipt" data-testid="approval-receipt" data-approval-id={receipt.approvalId}>
